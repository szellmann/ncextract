// ncextract - NCAR variable extractor
// Contact: Stefan Zellmann, info@szellmann.de
//
// This file is part of ncextract.
//
// ncextract is free software; you can redistribute it and/or
